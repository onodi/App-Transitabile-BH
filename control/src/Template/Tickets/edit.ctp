...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Parklots'), ['controller' => 'Parklots', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('New Parklot'), ['controller' => 'Parklots', 'action' => 'add']) ?></li>
    </ul>
</nav>
<div class="tickets form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('parklot_id', ['options' => $parklots]);
